...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">f-manage documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AddEditUser.html" data-type="entity-link" >AddEditUser</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/FilesCompoenent.html" data-type="entity-link" >FilesCompoenent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/UploadFileModal.html" data-type="entity-link" >UploadFileModal</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/IndexedDBService.html" data-type="entity-link" >IndexedDBService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/FManageDB.html" data-type="entity-link" >FManageDB</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="pipes-links"' : 'id="xs-pipes-links"' }>
                                <li class="link">
                                    <a href="pipes/PhoneNumberPipe.html" data-type="entity-link" >PhoneNumberPipe</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
